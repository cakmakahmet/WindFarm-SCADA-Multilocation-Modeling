...
| Model         | FE | Val MAE | Val RMSE | Val R²   | Test MAE     | Test RMSE    | Test R²   |
|--------------|----|---------|----------|----------|--------------|--------------|-----------|
| LGBM         | ❌ | –       | –        | –        | 0.140147     | 0.192319     | 0.4852    |
| LGBM         | ✔  | –       | –        | –        | **0.019478** | **0.028021** | **0.9891** |
| RandomForest | ❌ | –       | –        | –        | 0.141134     | 0.193585     | 0.4784    |
| RandomForest | ✔  | **29.053** | **52.281** | **0.9980** | 0.019829     | 0.029297     | 0.9881    |
| XGBoost      | ❌ | –       | –        | –        | 0.140453     | 0.192802     | 0.4826    |
| XGBoost      | ✔  | **25.515** | **40.480** | **0.9988** | **0.019385** | **0.027914** | **0.9892** |
...
| Model         | FE | Val MAE | Test MAE_norm | Test RMSE_norm | Test R²   | 90% Band Coverage |
|---------------|----|---------|----------------|-----------------|-----------|--------------------|
| LGBM          | ❌ | –       | 0.06287        | 0.13354         | 0.8793    | 60.65%             |
| LGBM          | ✔  | –       | **0.01138**    | **0.01717**     | **0.9976** | 60.65%             |
| RandomForest  | ❌ | –       | 0.05982        | 0.12757         | 0.8899    | 72.11%             |
| RandomForest  | ✔  | **29.053** | **0.01273**    | **0.02374**     | **0.9954** | **95.79%**         |
| XGBoost       | ❌ | –       | 0.06192        | 0.13038         | 0.8850    | 75.42%             |
| XGBoost       | ✔  | **25.515** | **0.01063**    | **0.01747**     | **0.9975** | 71.14%             |
| **CHWM (Hybrid Final)** | ✔ | **25.134** | **0.01066**    | **0.01786**     | **0.9974** | **95.79%** |
